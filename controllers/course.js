...
exports.CreateCourse=async(req,res)=>
{
    try {
        ...
        // validation
        // Category
  const {CourseName,CourseDescription,Price,Category,Tag,WhatYouWillLearn}=req.body;
const Thumbnail=req.files.Thumbnail;

console.log("CourseName,CourseDescription,Price,Category,WhatYouWillLearn==>",
...
const Updated_Course= await User.findByIdAndUpdate({_id:UserId},{
    $push:
    {
